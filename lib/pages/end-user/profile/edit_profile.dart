...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  void initState() {
    super.initState();
    _loadSavedData();
    // Add listener to role controller
  ...
  Future<void> _loadSavedData() async {
    ...
    setState(() {
      ...
      _roleController.text = _prefs.getString('jobTitle') ?? '';
    });
  }

  void _onFieldChanged() {
    if (widget.onProfileUpdated != null) {
      widget.onProfileUpdated!({'jobTitle': _roleController.text});
    }
  }
  ...
  Future<void> _saveProfile() async {
    if (_formKey.currentState!.validate()) {
      ...
      await _prefs.setString('jobTitle', _roleController.text);

      if (mounted) {
        // Return the updated profile data to the previous screen
        Navigator.pop(context, {
          'jobTitle': _roleController.text,
